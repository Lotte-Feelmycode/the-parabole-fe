...
export const COUPON_ENROLL_ERROR = Object.freeze({
  ...
  EXCESS_COUPON_CNT: '쿠폰은 최대 100장까지만 발급 가능합니다.',
});
...
export const AUTH_ERROR = Object.freeze({
  ...
  NO_PASSWORD_CONFIRMATION: '비밀번호 확인란을 입력해주세요.',
  INADEQUATE_PASSWORD:
    '영문, 숫자, 특수기호 조합으로 8-20자리 이상 입력해주세요.',
  NO_USERNAME: '사용자 이름을 입력해주세요.',
  NO_NICKNAME: '닉네임을 입력해주세요.',
  NO_PHONE: '전화번호를 입력해주세요.',
  NOT_IDENTICAL: '확인을 위해 입력한 비밀번호가 일치하지 않습니다.',
});
